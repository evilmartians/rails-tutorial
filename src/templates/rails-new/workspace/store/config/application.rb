...
module ActiveRecord
  ...
  module ConnectionAdapters
    class SQLite3WasmNewAdapter < SQLite3Adapter
...
ActiveRecord::ConnectionAdapters.register("sqlite3_wasm", "ActiveRecord::ConnectionAdapters::SQLite3WasmNewAdapter", "active_record/connection_adapters/sqlite3_adapter")
